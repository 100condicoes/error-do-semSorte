...
import { Text, View, TouchableOpacity, ImageBackground, Image, StatusBar, SafeAreaView, Platform, StyleSheet, Alert} from "react-native";
import MapView,{ Maker} from "react-native-maps";
import axios from "axios";


export default class Localisador extends Component{
    constructor(props) {
        super(props);
        this.state= {
            location: {},
    ...
    render(){
        ...
        return(
            ...
            <Text style={styles.titleText}> localisação de EEI</Text>
            <View style={styles.mapContainer}>
                <MapView style={styles.map} region={{
                    ...
                    <Maker coordinate = {{latitude: this.state.location.latitude,
                                          longitude: this.state.location.longitude}}>
